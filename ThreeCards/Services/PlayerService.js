...
module.exports = { 
    create: async function(data){
        ...
        try {
 			var playerSave = new player(data);
			 playerSave.save(async function (err,plr) {
			  if (err) console.log("Error :",err); return err;
			  // saved! 
			  console.log("Data :",plr);
			  return plr;
			});
    ...
    update: async function(id, data){
        console.log('Update Player Called -------:',data)
        try {
            player.findById(id, (err, player) => {
                if(err) return err;
                player.set(data); 
                player.save((updateErr, updatedPlayer) => {
    ...
    getByDeviceId: async function(device_id){
        console.log('Find Device ID:',device_id)
        try {
			return  await player.findOne({ device_id: device_id });
        } catch (e) {
            console.log("Erro",e);
        }
    },
    ...
    getByAppId: async function(appId){
        ...
        try {
			return  await player.findOne({ appid: appId });
        } catch (e) {
            console.log("Erro",e);
        }
	}
...
// 		player.save(async function (err,plr) {
// 		  if (err) return err;
// 		  // saved!
// 		  return plr;
// 		});
